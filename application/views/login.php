...
$title = 'Log in | Thesis Attendance Monitoring';
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>Login | Thesis Attendance</title>
        ...
        <link href="<?php echo base_url(); ?>libs/bootstrap/css/datepicker3.css" rel="stylesheet">
        <link href="<?php echo base_url(); ?>libs/bootstrap/css/styles.css" rel="stylesheet">
            ...
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <?php echo form_open(base_url('login/validate'), array('role' => 'form')) ?>
                        <fieldset>                            
